...
const MarketPanel: React.FC<MarketPanelProps> = ({ token, onAction, showConfirmation }) => {
        ...
        <div className="flex flex-col space-y-4">
            ...
            <div className="overflow-y-auto pr-2 space-y-3 flex-grow h-96">
                {isLoading ? <p className="text-center">Đang tải...</p> : 
                 filteredAndSortedListings.length > 0 ? filteredAndSortedListings.map(l => renderListingItem(l, false)) :
