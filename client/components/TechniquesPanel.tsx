...
import type { Player, TechniqueBonus } from '../types';
...
const TechniquesPanel: React.FC<TechniquesPanelProps> = ({ player, onActivateTechnique }) => {
    const availableTechniques = TECHNIQUES.filter(tech => player.realmIndex >= tech.requiredRealmIndex);
