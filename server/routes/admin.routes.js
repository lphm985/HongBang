...
// --- NEW: METADATA ENDPOINTS FOR ADMIN PANEL ---
router.get('/metadata/bonus-types', authenticateAdmin, (req, res) => {
    ...
    const bonusTypes = [
        ...
        'hp_mul', 'atk_mul', 'def_mul', 'qi_per_second_base_add', 'body_temper_eff_add', 'alchemy_success_base_add'
    ];
...
const createCrudEndpoints = (tableName, primaryKey = 'id') => {
    ...
    router.post(`/${tableName}`, authenticateAdmin, async (req, res) => {
        ...
        try {
            ...
            await conn.query(`INSERT INTO ${tableName} (${columns.join(', ')}) VALUES (${placeholders})`, values);
...
// --- NEW: Guild War Management Endpoints ---
